...
ui <- fluidPage(
        ...
        tags$h5("Select a city to start!"),
        fluidRow(
        ...
        observe({
                ...
                output$graphs <- renderPlot({
                        ...
                        actuallegendlabel <- switch(input$metric_type, 
                                               "Temperature" = ifelse(is.null(input$actualtemp),'Max Temperature', switch(input$actualtemp,
                                                                      "option1" = "Max Temperature",
                                                                      "option2" = "Mean Temperature",
                                                                      "option3" = "Min Temperature"
                                               )),
                                               "Humidity" = ifelse(is.null(input$var2),'Max Humidity',switch(input$var2,
                                                                   "option1" = "Max Humidity",
                                                                   "option2" = "Mean Humidity",
                                                                   "option3" = "Min Humidity"
                                               )),
                                               "Precipitation" = ifelse(is.null(input$var3),'Chance of Precipitation: 0',switch(input$var3,
                                               ...
                                               "Dew Point" = ifelse(is.null(input$var4),'Max Dew Point',switch(input$var4,
                                                                    "option1" = "Max Dew Point",
                                                                    "option2" = "Mean Dew Point",
                                                                    "option3" = "Min Dew Point"
                                               )),
                                               "Sea Level Pressure" = ifelse(is.null(input$var5),'Max Sea Level Pressure',switch(input$var5,
                                                                             "option1" = "Max Sea Level Pressure",
                                                                             "option2" = "Mean Sea Level Pressure",
                                                                             "option3" = "Min Sea Level Pressure"
                                               )),
                                               "Visibility" = ifelse(is.null(input$var6),'Max Visibility',switch(input$var6,
                                                                     "option1" = "Max Visibility",
                                                                     "option2" = "Mean Visibility",
                                                                     "option3" = "Min Visibility"
                                               )),
                                               "Wind Speed" = ifelse(is.null(input$var7),'Max Wind Speed',switch(input$var7,
                        ...
                        metricchoice <- switch(input$metric_type, 
                                "Temperature" = ifelse(is.null(input$actualtemp),'Max_TemperatureF',switch(input$actualtemp,
                                                "option1" = "Max_TemperatureF",
                                                "option2" = "Mean_TemperatureF",
                                                "option3" = "Min_TemperatureF"
                                )),
                                "Humidity" = ifelse(is.null(input$var2),'Max_Humidity',switch(input$var2,
                                                "option1" = "Max_Humidity",
                                                "option2" = "Mean_Humidity",
                                                "option3" = "Min_Humidity"
                                )),
                                "Precipitation" = ifelse(is.null(input$var3),'FProbPrecip_Days0',switch(input$var3,
                                ...
                                "Dew Point" = ifelse(is.null(input$var4),'Max_Dew_PointF',switch(input$var4,
                                                "option1" = "Max_Dew_PointF",
                                                "option2" = "MeanDew_PointF",
                                                "option3" = "Min_DewpointF"
                                )),
                                "Sea Level Pressure" = ifelse(is.null(input$var5),'Max_Sea_Level_PressureIn',switch(input$var5,
                                                "option1" = "Max_Sea_Level_PressureIn",
                                                "option2" = "Mean_Sea_Level_PressureIn",
                                                "option3" = "Min_Sea_Level_PressureIn"
                                )),
                                "Visibility" = ifelse(is.null(input$var6),'Max_VisibilityMiles',switch(input$var6,
                                                "option1" = "Max_VisibilityMiles",
                                                "option2" = "Mean_VisibilityMiles",
                                                "option3" = "Min_VisibilityMiles"
                                )),
                                "Wind Speed" = ifelse(is.null(input$var2),'Max_Wind_SpeedMPH',switch(input$var7,
